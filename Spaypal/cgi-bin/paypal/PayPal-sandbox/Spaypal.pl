...
$PLPL_session=$F{ppsession};
 ...
 $paypalform2.='
 <form method="post" action="https://www.sandbox.paypal.com/cgi-bin/webscr" enctype="multipart/form-data" onsubmit="javascript:document.getElementById(\'divPayPal\').innerHTML=\'<div class=message>Данные посланы. Ждите...</div>\';">
