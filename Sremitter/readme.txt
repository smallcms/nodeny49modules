...
Умеет:
    ...
    * защита от перевода временных платежей
...
n RMTR_priceprc		0	'Процент списания за пользование услугой (0 - не учитывать)'
...
6. Мониторинг платежей производится либо в платежах и событиях каждого получателя, либо Платежи -> Категории платежей -> в колонке Безналичное пополнение счета клиента -> Перевод с другого счета.
