...
n PRMP_dopid		0	'ID дополнительного параметра, для запрета пользования услугой конкретному клиенту (необходимо создать дополнительно в Операции - Настройки - Дополнительные поля, 0 - не учитывать)'
n PRMP_overdebt		0	'Максимальная сумма долга, при которой запрещено пользование услугой (по-умолчанию: 0)'
n PRMP_oldpay		0	'Если платежей не поступало столько дней, запретить пользоваться услугой (0 - не учитывать)'
