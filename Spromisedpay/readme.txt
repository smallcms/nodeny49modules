...
Умеет:
    ...
    * устанавливать количество возможностей пользования услогой в месяц (опционально)
...
n PRMP_mxmo		0	'Максимально допустимое количество пользования услогой в месяц начиная с первого числа (0 - не учитывать)'
