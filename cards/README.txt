...
4. Если необходимы работать с номиналами более 9999.99, то снимаем ограничение 
в SQL биллинга следующим запросом:
ALTER TABLE `cards` CHANGE `money` `money` FLOAT( 11, 2 ) NOT NULL DEFAULT '0.00'

5. Браузером заходим в админку NoDeny, меню "Операции". Если карточки не 
...
6. Активируем карточки.

7. Появляется столбец "Экспорт в CSV" . Нажимаем кнопку "Сохранить". Файл с csv
сохранится под названием nocards.txt.

ДАЛЕЕ ИНФОРМАЦИЯ БОЛЬШЕ ДЛЯ ТИПОГРАФИИ
8. При распечатывании в Windows создаём каталог C:\nocards\. Копируем туда файл
